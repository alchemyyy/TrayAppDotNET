...
public sealed class AppTheme : TrayAppDotNETCommon.Visuals.AppTheme
{
    ...
    {
        yield return ThemeColorElement(nameof(NetworkConnectedTrayIconColor), NetworkConnectedTrayIconColor);
        yield return ThemeColorElement(nameof(NetworkNoInternetTrayIconColor), NetworkNoInternetTrayIconColor);
        yield return ThemeColorElement(nameof(NetworkDisconnectedTrayIconColor), NetworkDisconnectedTrayIconColor);
        yield return new XElement(nameof(GlyphNetworkEthernet), GlyphNetworkEthernet);
        yield return new XElement(nameof(GlyphNetworkWifi0), GlyphNetworkWifi0);
        yield return new XElement(nameof(GlyphNetworkWifi1), GlyphNetworkWifi1);
        yield return new XElement(nameof(GlyphNetworkWifi2), GlyphNetworkWifi2);
        yield return new XElement(nameof(GlyphNetworkWifi3), GlyphNetworkWifi3);
        yield return new XElement(nameof(GlyphNetworkWifi4), GlyphNetworkWifi4);
        yield return new XElement(nameof(GlyphNetworkNone), GlyphNetworkNone);
    }

    protected override void ReadAdditionalXml(XElement root)
    {
        NetworkConnectedTrayIconColor =
            ReadThemeColor(root, nameof(NetworkConnectedTrayIconColor), NetworkConnectedTrayIconColor);
        NetworkNoInternetTrayIconColor =
            ReadThemeColor(root, nameof(NetworkNoInternetTrayIconColor), NetworkNoInternetTrayIconColor);
        NetworkDisconnectedTrayIconColor = ReadThemeColor(root, nameof(NetworkDisconnectedTrayIconColor),
            NetworkDisconnectedTrayIconColor);
        GlyphNetworkEthernet = ReadString(root, nameof(GlyphNetworkEthernet), GlyphCatalog.NETWORK_ETHERNET);
        GlyphNetworkWifi0 = ReadString(root, nameof(GlyphNetworkWifi0), GlyphCatalog.NETWORK_WIFI_0);
        GlyphNetworkWifi1 = ReadString(root, nameof(GlyphNetworkWifi1), GlyphCatalog.NETWORK_WIFI_1);
        GlyphNetworkWifi2 = ReadString(root, nameof(GlyphNetworkWifi2), GlyphCatalog.NETWORK_WIFI_2);
        GlyphNetworkWifi3 = ReadString(root, nameof(GlyphNetworkWifi3), GlyphCatalog.NETWORK_WIFI_3);
        GlyphNetworkWifi4 = ReadString(root, nameof(GlyphNetworkWifi4), GlyphCatalog.NETWORK_WIFI_4);
        GlyphNetworkNone = ReadString(root, nameof(GlyphNetworkNone), GlyphCatalog.NETWORK_NONE);
    }
