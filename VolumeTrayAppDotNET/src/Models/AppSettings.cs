...
public class AppSettings : AppSettingsCommon
{
    ...
    // Audible feedback on playback-device volume changes (not capture devices).
    ...
    // default. Route-specific settings can still gate individual gestures such as tray icon scrolling.
    ...
    public bool PlayTrayScrollVolumeChangeSound
    {
        get;
        set => SetField(ref field, value);
    } = true;
