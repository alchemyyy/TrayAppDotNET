...
public sealed partial class VolumeFlyoutWindow : FlyoutWindowCommon
{
    ...
    private Grid BuildHeader(FlyoutPalette p)
    {
        ...
        StackPanel left = new()
        {
            ...
            VerticalAlignment = _settings.FlyoutHeaderAtBottom ? VerticalAlignment.Bottom : VerticalAlignment.Top,
            Margin = _settings.FlyoutHeaderAtBottom ? Layout.HeaderLeftMarginBottom : Layout.HeaderLeftMarginTop,
        };

        left.Children.Add(HeaderIconButton(GlyphCatalog.SETTINGS, p, _openSettings,
        ...
        if (IsUpdateButtonVisible)
        {
            ...
            update.VerticalAlignment =
                _settings.FlyoutHeaderAtBottom ? VerticalAlignment.Bottom : VerticalAlignment.Top;
            update.Margin = _settings.FlyoutHeaderAtBottom
                ? Layout.HeaderUpdateMarginBottom
        ...
        undock.VerticalAlignment = _settings.FlyoutHeaderAtBottom ? VerticalAlignment.Bottom : VerticalAlignment.Top;
        undock.Margin = _settings.FlyoutHeaderAtBottom ? Layout.HeaderUndockMarginBottom : Layout.HeaderUndockMarginTop;
