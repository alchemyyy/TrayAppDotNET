...
public sealed class VolumeUninstallerWindow : Window
{
    private readonly string _installDir;
    private readonly VolumeInstallScope _scope;
    ...
    public VolumeUninstallerWindow(string installDir, VolumeInstallScope scope)
    {
        ...
        _scope = scope;
        Title = L("Uninstaller_Title", "Uninstall VolumeTrayAppDotNET");
        Width = 520;
        Height = 360;
        MinWidth = 420;
        MinHeight = 320;
    ...
    private Grid BuildTitleBar(SettingsPalette p)
    {
        ...
        TextBlock title = TrayAppDotNETSettingsUI.Text(L("Uninstaller_Title", "Uninstall VolumeTrayAppDotNET"), p, 13);
    ...
    private Grid BuildBody(SettingsPalette p, bool rounded, StackPanel buttons)
    {
        ...
        TextBlock header = TrayAppDotNETSettingsUI.SectionHeader(
            L("Uninstaller_SectionHeader", "Uninstall VolumeTrayAppDotNET"),
            p);
        ...
        TextBlock description = TrayAppDotNETSettingsUI.DescriptionText(
            string.Format(
                L("Uninstaller_Description_Format",
                    "This will remove VolumeTrayAppDotNET installed at \"{0}\" and its entry in Windows Settings > Apps. Choose what to do with your settings."),
                _installDir),
            p,
