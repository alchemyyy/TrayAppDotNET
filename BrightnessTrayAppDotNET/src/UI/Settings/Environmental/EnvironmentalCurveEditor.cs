...
public readonly record struct EnvironmentalCurveEditorPalette(
    ...
    Color Accent)
{
    public static EnvironmentalCurveEditorPalette Default { get; } = new(
        Background: Colors.Transparent,
        Foreground: Color.FromRgb(255, 255, 255),
        SecondaryForeground: Color.FromArgb(210, 255, 255, 255),
        CardBackground: Color.FromRgb(43, 43, 43),
        Border: Color.FromRgb(69, 69, 69),
        GridLine: Color.FromRgb(147, 147, 147),
        BrightnessCurve: Color.FromRgb(235, 192, 81),
        NightLightCurve: Color.FromRgb(132, 126, 255),
        CurrentTime: Color.FromRgb(255, 255, 255),
        TwilightBackdrop: Color.FromArgb(42, 255, 177, 95),
        NightBackdrop: Color.FromArgb(58, 54, 78, 116),
        DisabledBand: Color.FromArgb(20, 255, 255, 255),
        PreviewTint: Color.FromArgb(16, 255, 255, 255),
        ...
        Color disabledBand)
    {
        return new EnvironmentalCurveEditorPalette(
            ...
            PreviewTint: WithAlpha(palette.Foreground, 16),
