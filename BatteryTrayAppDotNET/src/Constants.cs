...
{
    public const string ApplicationName = "BatteryTrayAppDotNET";
    ...
    public const string AppGUID = "c18465d2-f5cd-470a-844e-54c72f60b610";
    public const string TrayIconGUID = "bfe92362-cda6-49b0-beae-375758fd6f97";
