...
internal sealed class TrayAppDotNETSaturationValuePicker : Control
{
    ...
    private Color _hueColor = Colors.Red;
    ...
    public override void Render(DrawingContext context)
    {
        ...
        context.FillRectangle(CreateGradient(Colors.White, Color.FromArgb(0, 255, 255, 255), horizontal: true), bounds,
            6);
        context.FillRectangle(CreateGradient(Color.FromArgb(0, 0, 0, 0), Colors.Black, horizontal: false), bounds, 6);
        ...
        context.DrawEllipse(Brushes.Transparent, new Pen(Brushes.Black), center, 8, 8);
        context.DrawEllipse(new SolidColorBrush(_currentColor), new Pen(Brushes.White), center, 7, 7);
    }
...
internal sealed class TrayAppDotNETColorSlider : Control
{
    ...
    private LinearGradientBrush CreateBarGradient()
    {
        ...
        if (_kind == TrayAppDotNETColorSliderKind.Hue)
        {
            ...
            brush.GradientStops.Add(new GradientStop(Colors.Magenta, 1.0 / 6.0));
            brush.GradientStops.Add(new GradientStop(Colors.Blue, 2.0 / 6.0));
            brush.GradientStops.Add(new GradientStop(Colors.Cyan, 3.0 / 6.0));
            brush.GradientStops.Add(new GradientStop(Colors.Lime, 4.0 / 6.0));
            brush.GradientStops.Add(new GradientStop(Colors.Yellow, 5.0 / 6.0));
