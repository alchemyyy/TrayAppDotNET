...
public sealed class FanUninstallerWindow : Window
{
    ...
    public FanUninstallerWindow(string installDir, FanInstallScope scope)
    {
        ...
        FanInstallScope scope1 = scope;
        Title = L("Uninstaller_Title", "Uninstall FanControlTrayAppDotNET");
        Width = 520;
        Height = 360;
        MinWidth = 420;
        MinHeight = 320;
        ...
        SettingsPalette p = FanSettingsWindow.CreatePalette(AppServices.Theme, settings,
        ...
        chrome.Children.Add(BuildTitleBar(p));
    ...
    private Grid BuildTitleBar(SettingsPalette p)
    {
        ...
        TextBlock title =
            TrayAppDotNETSettingsUI.Text(L("Uninstaller_Title", "Uninstall FanControlTrayAppDotNET"), p, 13);
        title.VerticalAlignment = VerticalAlignment.Center;
        title.Margin = new Thickness(16, 0, 0, 0);
        titleBar.Children.Add(title);

        FanUninstallerCaptionButton close = new(p);
    ...
    private Grid BuildBody(SettingsPalette p, bool rounded, StackPanel buttons)
    {
        ...
        TextBlock header = TrayAppDotNETSettingsUI.SectionHeader(
            L("Uninstaller_SectionHeader", "Uninstall FanControlTrayAppDotNET"),
            p);
        ...
        TextBlock description = TrayAppDotNETSettingsUI.DescriptionText(
            string.Format(
                L("Uninstaller_Description_Format",
                    "This will remove FanControlTrayAppDotNET installed at \"{0}\" and its entry in Windows Settings > Apps. Choose what to do with your settings."),
                _installDir),
            p,
...
internal sealed class FanUninstallerCaptionButton : Border
{
    ...
    public FanUninstallerCaptionButton(SettingsPalette palette)
    {
        _palette = palette;
        Width = 46;
        Height = 32;
