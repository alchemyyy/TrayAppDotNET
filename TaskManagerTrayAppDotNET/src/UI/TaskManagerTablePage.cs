...
internal class TaskManagerTablePage : TaskManagerPageLayout, ITaskManagerSearchOverlayPage, IDisposable
{
    ...
    private void OnAXAMLResourcesReloaded()
    {
        ...
        _tableScrollViewport.SetScrollBarStyle(CreateTableScrollBarStyle(_resources));
        _tableScrollViewport.SetVerticalScrollBarTopInset(_resources.AxamlProcessTable.HeaderHeight);
