...
This script intentionally uses only Python's standard library. It installs:
  ...
  - Visual Studio Build Tools with the C++ workload for win-x64 Native AOT
...
Installed or verified by this script:
  ...
  - Visual Studio Build Tools with the C++ workload, required for win-x64 Native AOT
...
def print_prerequisites() -> None:
    ...
    print("    - GitHub CLI")
    print("    - .NET SDK")
    print("    - Visual Studio Build Tools C++ workload for Native AOT")
